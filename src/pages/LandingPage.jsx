    ...
    return (
        <section className="relative text-center px-6 py-24 overflow-hidden">
            ...
            <section className="relative max-w-6xl mx-auto px-6 mt-40">
                ...
                <div className="relative w-full mx-auto rounded-3xl bg-linear-to-r from-gray-500/20 via-gray-700/20 to-black backdrop-blur-xl p-12 md:p-16 flex flex-col lg:flex-row items-center justify-between gap-10 shadow-2xl">
